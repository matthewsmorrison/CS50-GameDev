...
function love.update(dt)
    ...
    elseif love.keyboard.isDown('s') then
        ...
        player1Y = math.min(VIRTUAL_HEIGHT - PADDLE_SIZE, player1Y + PADDLE_SPEED * dt)
    end
    ...
    elseif love.keyboard.isDown('down') then
        -- add positive paddle speed to current Y scaled by deltaTime
        player2Y = math.min(VIRTUAL_HEIGHT - PADDLE_SIZE, player2Y + PADDLE_SPEED * dt)
    end
...
function love.draw()
    ...
    love.graphics.rectangle('fill', 10, player1Y, 5, PADDLE_SIZE)
